...
import tr.com.gndg.self.core.util.supplierZero
import tr.com.gndg.self.domain.model.Supplier

@Composable
fun ArrivalBySupplierDialog(
    onDismiss: () -> Unit,
    supplierList : List<Supplier>,
    selectedSupplier : (Supplier) -> Unit,
) {

    val context = LocalContext.current
    val withZero = supplierList.toMutableList()
    withZero.add(supplierZero(context))
        ...
        OutlinedCard(
            ...
            Column {
                ...
                Row(
                    ...
                    TextButton(
                        onClick = { selectedSupplier(selected) },
                    ) {

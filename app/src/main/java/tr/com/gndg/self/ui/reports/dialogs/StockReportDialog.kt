...
@Composable
fun StockReportDialog(
    onDismiss: () -> Unit,
    warehouseList : List<Warehouse>,
    selectedWarehouse : (Warehouse) -> Unit,
) {
    val context = LocalContext.current
    val withZero = warehouseList.toMutableList()
        withZero.add(warehouseZero(context))
        ...
        OutlinedCard(
            ...
            Column {
                ...
                Row(
                    ...
                    TextButton(
                        onClick = { selectedWarehouse(selected) },
                    ) {
